...
(5) In-situ reference measurements, recommended using hierarchy of decreasing quality: - BEST: Optodes attached to a CTD ({numref}deployment_ship_CTD). - BEST: multiple co-located CTD casts. - GOOD: ?? - OK: ??
